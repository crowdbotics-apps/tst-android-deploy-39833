"""
Django settings for tst_android_deploy_39833 project.
...
ROOT_URLCONF = 'tst_android_deploy_39833.urls'
...
WSGI_APPLICATION = 'tst_android_deploy_39833.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_android_deploy_39833 API",
    "DESCRIPTION": "API documentation for tst_android_deploy_39833 App",
    "VERSION": "v1",
}
